...
pplx::task<std::shared_ptr<Object>> AttachmentsApi::attachmentsPost(std::shared_ptr<CreateAttachmentDto> createAttachmentDto)
{
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling attachmentsPost: unsupported response type"));
        }

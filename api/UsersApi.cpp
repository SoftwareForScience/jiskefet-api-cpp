...
pplx::task<std::shared_ptr<Object>> UsersApi::usersIdGet(int32_t id)
{
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling usersIdGet: unsupported response type"));
        }

        return result;
    });
}
pplx::task<std::shared_ptr<Object>> UsersApi::usersIdTokensGet(int32_t id)
{
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling usersIdTokensGet: unsupported response type"));
        }

        return result;
    });
}
pplx::task<void> UsersApi::usersIdTokensNewPost(int32_t id, std::shared_ptr<CreateSubSystemPermissionDto> createSubSystemPermissionDto)
{

    // verify the required parameter 'createSubSystemPermissionDto' is set
    if (createSubSystemPermissionDto == nullptr)
    {
        throw ApiException(400, utility::conversions::to_string_t("Missing required parameter 'createSubSystemPermissionDto' when calling UsersApi->usersIdTokensNewPost"));
    }


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/users/{id}/tokens/new");
    boost::replace_all(path, utility::conversions::to_string_t("{") + utility::conversions::to_string_t("id") + utility::conversions::to_string_t("}"), ApiClient::parameterToString(id));
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("UsersApi->usersIdTokensNewPost does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("UsersApi->usersIdTokensNewPost does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling usersIdTokensNewPost: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling usersIdTokensNewPost: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }

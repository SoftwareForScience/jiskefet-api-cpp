...
pplx::task<std::shared_ptr<Object>> LogsApi::logsGet(boost::optional<utility::string_t> orderBy, boost::optional<utility::string_t> orderDirection, boost::optional<utility::string_t> pageSize, boost::optional<utility::string_t> pageNumber, boost::optional<utility::string_t> logId, boost::optional<utility::string_t> searchterm, boost::optional<utility::string_t> subtype, boost::optional<utility::string_t> origin, boost::optional<utility::string_t> startCreationTime, boost::optional<utility::string_t> endCreationTime)
{
...
pplx::task<std::shared_ptr<Object>> LogsApi::logsIdGet(int32_t id)
{
...
pplx::task<std::shared_ptr<Object>> LogsApi::logsIdRunsPatch(std::shared_ptr<LinkRunToLogDto> linkRunToLogDto, int32_t id)
{
...
pplx::task<void> LogsApi::logsPost(std::shared_ptr<CreateLogDto> createLogDto)
{

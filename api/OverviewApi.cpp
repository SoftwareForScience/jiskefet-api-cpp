...
pplx::task<std::shared_ptr<Object>> OverviewApi::overviewGet(boost::optional<utility::string_t> timeRange)
{
    ...
    .then([=](utility::string_t response)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling overviewGet: unsupported response type"));
        }

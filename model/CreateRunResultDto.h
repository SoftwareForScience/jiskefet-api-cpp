...
/*
 * CreateRunResultDto.h
 *
 * 
 */

#ifndef IO_SWAGGER_CLIENT_MODEL_CreateRunResultDto_H_
#define IO_SWAGGER_CLIENT_MODEL_CreateRunResultDto_H_
...
/// 
/// </summary>
class  CreateRunResultDto
    : public ModelBase
{
public:
    CreateRunResultDto();
    virtual ~CreateRunResultDto();
...
#endif /* IO_SWAGGER_CLIENT_MODEL_CreateRunResultDto_H_ */

...
pplx::task<void> LogsApi::logsGet(boost::optional<utility::string_t> orderBy, boost::optional<utility::string_t> orderDirection, boost::optional<int64_t> pageSize, boost::optional<int64_t> pageNumber, boost::optional<int64_t> logId, boost::optional<utility::string_t> searchterm, boost::optional<utility::string_t> subtype, boost::optional<utility::string_t> origin, boost::optional<utility::string_t> startCreationTime, boost::optional<utility::string_t> endCreationTime, boost::optional<int64_t> user)
{
...
pplx::task<void> LogsApi::logsIdGet(int64_t id)
{
...
pplx::task<void> LogsApi::logsIdRunsPatch(std::shared_ptr<LinkRunToLogDto> linkRunToLogDto, int64_t id)
{
...
pplx::task<std::shared_ptr<Log>> LogsApi::logsPost(std::shared_ptr<CreateLogDto> createLogDto)
{
    ...
    .then([=](utility::string_t response)
    {
        std::shared_ptr<Log> result(new Log());

...
pplx::task<void> FlpApi::flpNameRunsIdGet(utility::string_t name, int64_t id)
{
...
pplx::task<void> FlpApi::flpNameRunsIdPatch(std::shared_ptr<PatchFlpDto> patchFlpDto, utility::string_t name, int64_t id)
{
...
pplx::task<void> FlpApi::flpPost(std::shared_ptr<CreateFlpDto> createFlpDto)
{

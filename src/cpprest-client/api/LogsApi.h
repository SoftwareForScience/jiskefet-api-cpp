...
public:
    ...
    /// </remarks>
    /// <param name="id"></param>
    pplx::task<void> logsIdGet(
        int64_t id
    );
    /// <summary>
    /// Links a Run to a specific Log.
    /// </summary>
    /// <remarks>
    /// 
    /// </remarks>
    ...
    /// <param name="id"></param>
    pplx::task<void> logsIdRunsPatch(
    ...
    pplx::task<std::shared_ptr<Log>> logsPost(

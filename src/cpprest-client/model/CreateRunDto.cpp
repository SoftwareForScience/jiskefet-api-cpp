...
int64_t CreateRunDto::getRunNumber() const
{
    return m_RunNumber;
}


void CreateRunDto::setRunNumber(int64_t value)
{
    m_RunNumber = value;
...
int64_t CreateRunDto::getNDetectors() const
{
    return m_NDetectors;
}


void CreateRunDto::setNDetectors(int64_t value)
{
    m_NDetectors = value;
    
}
int64_t CreateRunDto::getNFlps() const
{
    return m_NFlps;
}


void CreateRunDto::setNFlps(int64_t value)
{
    m_NFlps = value;
    
}
int64_t CreateRunDto::getNEpns() const
{
    return m_NEpns;
}


void CreateRunDto::setNEpns(int64_t value)
{
    m_NEpns = value;
